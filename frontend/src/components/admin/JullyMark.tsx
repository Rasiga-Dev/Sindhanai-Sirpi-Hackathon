...
/api/jully/latest')
            .then((res) => {
                if (res.data) {
                    setPdfURL(`https://sindhanai-sirpi-hackathon-1.onrender.com
...
/api/jully/upload', formData, {
            ...
            const previewURL = `https://sindhanai-sirpi-hackathon-1.onrender.com
            ...
            {showListMode && (
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* <div>
                            <label className="block font-medium mb-1">Preview Document:</label>
                            {pdfURL ? (
                                <iframe
                                    src={pdfURL}
